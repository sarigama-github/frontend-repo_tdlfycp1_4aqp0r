    ...
    <section id="home" className="relative min-h-[90vh] grid place-items-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <p className="mt-5 max-w-2xl mx-auto text-red-200/85">
          A chilling showcase of 3D models, procedural horrors and eerie visual experiments.
        </p>
        <div className="mt-8 flex items-center justify-center gap-4">
          <a href="#gallery" className="px-5 py-3 rounded-xl bg-red-600 hover:bg-red-500 text-white shadow-[0_0_35px_-8px_rgba(239,68,68,0.8)] transition">Explore Gallery</a>
          <a href="#about" className="px-5 py-3 rounded-xl border border-red-500/40 text-red-200 hover:border-red-400 hover:text-red-100 transition">About Me</a>
        </div>
      </div>
